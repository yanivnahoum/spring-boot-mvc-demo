...
import static com.att.training.spring.boot.demo.HttpServicePropertiesTest.URL;
import static org.assertj.core.api.Assertions.assertThat;

@SpringBootTest
@ContextConfiguration(classes = HttpServicePropertiesTest.TestConfiguration.class)
@TestPropertySource(properties = "app.http-service.url=" + URL)
class HttpServicePropertiesTest {
    ...
    static final String URL = "https://some-domain.com:8080";
    ...
    class WithSpecifiedValues {
        ...
        void immutablePojosCanBeUsedAsConfigurationProperties() {
            var expectedProperties = new HttpServiceProperties(URL, Duration.ofSeconds(5),
    ...
    class WithDefaultValues {
        ...
        @Test
        void immutablePojosCanBeUsedAsConfigurationProperties() {
            var expectedProperties = new HttpServiceProperties(URL, Duration.ofSeconds(30),
